            ...
            function link(scope, elem, attrs, ctrl) {
                ...
                function keydownHandler(event) {
                    ...
                    if (which === KEY_EN) {
                        ...
                        if (!scope.searchStr || scope.searchStr.trim().length == 0) {
                            scope.searchStr = scope.backspaceKeyDown();
                            scope.$digest();
